...
const SOCIALS = [
  {
    label: "Instagram",
    handle: "@ratelsstore",
    href: "https://www.instagram.com/ratelsstore",
    icon: (
  ...
  },
  {
    label: "TikTok",
    handle: "@ratelsstore",
    href: "https://www.tiktok.com/@ratelsstore",
    icon: (
  ...
  },
  {
    label: "Facebook",
    handle: "RATELS Store",
    href: "https://www.facebook.com/ratelsstore",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px]">
        ...
        <div className="w-full max-w-[420px] py-16">
          ...
          {tab === "email" && (
            <div className="text-center">
              ...
              <a
                href="mailto:ratelsstore@gmail.com?subject=Enquiry from RATELS Store"
          ...
          {tab === "phone" && (
            <div className="text-center">
              <p className="text-[#6b6560] text-[13px] mb-6 leading-relaxed">
                Tap below to call or WhatsApp us directly.
              </p>
              <a
                href="tel:+2348000000000"
                className="flex items-center justify-center gap-3 w-full bg-[#1a1a1a] text-white py-4 text-[13px] tracking-[0.15em] uppercase hover:bg-[#333] transition-colors duration-300 mb-3"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-4 h-4">
              ...
              {/* WhatsApp CTA */}
              <a
                href="https://wa.me/2348000000000?text=Hi%20RATELS%2C%20I%20have%20an%20enquiry"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 w-full border border-neutral-200 text-[#1a1a1a] py-4 text-[13px] tracking-[0.15em] uppercase hover:border-[#1a1a1a] transition-colors duration-300"
              >
