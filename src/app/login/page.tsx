          ...
          {!sent ? (
            <>
              ...
              <p className="text-[11px] text-[#ccc] mt-8 leading-relaxed">
                Admin access is by invitation only. Customers don&apos;t need an account to shop.
              </p>
            </>
          ) : (
            <div className="text-center">
              ...
              <p className="text-[#6b6560] text-[14px] leading-relaxed mb-8">
                We sent a magic link to <strong>{email}</strong>. Tap it to sign in — expires in 1 hour.
              </p>
              <button
